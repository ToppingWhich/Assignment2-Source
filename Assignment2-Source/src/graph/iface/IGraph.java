...
/**
 * Graph ADT. A graph is a data structure consisting of vertices that are connected with edges.
 *
 * @param <V> Generic type stored in vertex objects.
 * @param <E> Generic type stored in edge objects.
 */
